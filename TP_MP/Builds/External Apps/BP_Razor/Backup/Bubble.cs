...
namespace BP_Razor
{
  public class Bubble : Sprite
  {
    ...
    {
      ((Vector2) ref this.TopLeft).X = 18f;
      ((Vector2) ref this.TopLeft).Y = -18f;
      ((Vector2) ref this.BottomLeft).X = 18f;
      ((Vector2) ref this.BottomLeft).Y = 16f;
      ((Vector2) ref this.BottomRight).X = -18f;
      ((Vector2) ref this.BottomRight).Y = 16f;
      ((Vector2) ref this.TopRight).X = -18f;
      ((Vector2) ref this.TopRight).Y = -18f;
      ((HitBox) ref this.BubbleHitBox).Set(this.TopLeft, this.BottomLeft, this.BottomRight, this.TopRight);
    ...
    public virtual void Update(double elapsed)
    {
      ...
      else
      {
              ...
              switch (sprite)
              {
                ...
                case Monkey _:
                  if (this.m_monkeyID != ((Monkey) sprite).MonkeyID)
                  {
                    ...
                    this.m_ignore = false;
                    this.m_dBubbleMonkey = 3.5;
                    ((Vector2) ref this.m_Velocity).Y = 0.0f;
                  }
                  if (!this.m_ignore)
                  {
                    ...
                    if (this.m_dBubbleMonkey <= 0.0)
                    {
                      this.m_ignore = true;
                      this.m_dBubbleMonkey = 3.5;
                      ((Vector2) ref this.m_Velocity).Y = 10f;
        ...
        double x = (double) ((Vector2) ref velocity1).X;
        Vector2 velocity2 = this.Velocity;
        double y = (double) ((Vector2) ref velocity2).Y;
