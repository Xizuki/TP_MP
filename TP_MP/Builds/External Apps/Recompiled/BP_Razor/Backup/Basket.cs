...
namespace BP_Razor
{
  public class Basket : Sprite
  {
    ...
    {
      ((Vector2) ref this.TopLeft).X = -100f;
      ((Vector2) ref this.TopLeft).Y = -20f;
      ((Vector2) ref this.BottomLeft).X = -100f;
      ((Vector2) ref this.BottomLeft).Y = -10f;
      ((Vector2) ref this.BottomRight).X = 100f;
      ((Vector2) ref this.BottomRight).Y = -10f;
      ((Vector2) ref this.TopRight).X = 100f;
      ((Vector2) ref this.TopRight).Y = -20f;
      ((HitBox) ref this.BasketHitBox).Set(this.TopLeft, this.BottomLeft, this.BottomRight, this.TopRight);
    ...
    {
      ((Vector2) ref this.TopLeft).X = -100f;
      ((Vector2) ref this.TopLeft).Y = -10f;
      ((Vector2) ref this.BottomLeft).X = -100f;
      ((Vector2) ref this.BottomLeft).Y = 0.0f;
      ((Vector2) ref this.BottomRight).X = 100f;
      ((Vector2) ref this.BottomRight).Y = 0.0f;
      ((Vector2) ref this.TopRight).X = 100f;
      ((Vector2) ref this.TopRight).Y = -10f;
      ((HitBox) ref this.BasketHitBox).Set(this.TopLeft, this.BottomLeft, this.BottomRight, this.TopRight);
      return this.BasketHitBox;
    }
