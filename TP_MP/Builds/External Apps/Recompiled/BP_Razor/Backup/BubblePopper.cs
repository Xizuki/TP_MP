...
namespace BP_Razor
{
  public class BubblePopper : Game
  {
    ...
    public void GenerateArrow(int arrowType, Matrix matrix)
    {
      ...
      ((Vector2) ref vector2_1).\u002Ector(700f, 0.0f);
      ...
      try
      {
        foreach (Sprite sprite in Game.m_Sprites)
        {
          if (sprite != this.m_Background & !(sprite is Arrow) & !(sprite is Bubble))
          {
            ...
            if (hitBoxes2 != null)
            {
              if (((HitBox) ref hitBoxes1[0]).IntersectWith(hitBoxes2[0]))
                sprite.LocalMatrix.Translate(((Vector2) ref hitBoxes1[0].Center).X + ((Vector2) ref hitBoxes1[0].Extents).X + ((Vector2) ref hitBoxes2[0].Extents).X - ((Vector2) ref hitBoxes2[0].Center).X, 0.0f, MatrixOrder.Append);
              if (((HitBox) ref hitBoxes1[1]).IntersectWith(hitBoxes2[0]))
                sprite.LocalMatrix.Translate(((Vector2) ref hitBoxes1[1].Center).X - ((Vector2) ref hitBoxes1[1].Extents).X - ((Vector2) ref hitBoxes2[0].Extents).X - ((Vector2) ref hitBoxes2[0].Center).X, 0.0f, MatrixOrder.Append);
              if (((HitBox) ref hitBoxes1[2]).IntersectWith(hitBoxes2[0]))
                sprite.LocalMatrix.Translate(0.0f, ((Vector2) ref hitBoxes1[2].Center).Y + ((Vector2) ref hitBoxes1[2].Extents).Y + ((Vector2) ref hitBoxes2[0].Extents).Y - ((Vector2) ref hitBoxes2[0].Center).Y, MatrixOrder.Append);
              if (((HitBox) ref hitBoxes1[3]).IntersectWith(hitBoxes2[0]))
                sprite.LocalMatrix.Translate(0.0f, ((Vector2) ref hitBoxes1[3].Center).Y - ((Vector2) ref hitBoxes1[3].Extents).Y - ((Vector2) ref hitBoxes2[0].Extents).Y - ((Vector2) ref hitBoxes2[0].Center).Y, MatrixOrder.Append);
            }
          }
        }
      }
