...
namespace BP_Razor
{
  public class TarzanBoy : Player
  {
    ...
    private HitBox getTarzanHitbox()
    {
      ...
      (TopRight).X = 34f;
      (TopRight).Y = 40f;
      (TarzanBoyHitBox).Set(this.TopLeft, this.BottomLeft, this.BottomRight, this.TopRight);
    ...
    public void Reset()
    {
      ...
      Vector2 vector2 = new Vector2(0.0f, 150f);
    ...
    private void keyDownTriggered()
    {
      ...
      if ((double) ((Sprite) this).LocalMatrix.OffsetX < 0.0)
      {
        ...
        double x = (double) ((Vector2) velocity2).X;
        Vector2 velocity3 = ((Sprite) this).Velocity;
        double y = (double) ((Vector2) velocity3).Y;
        ...
        double offsetX = -(double) ((Vector2) velocity1).X;
        Vector2 velocity4 = ((Sprite) this).Velocity;
        double offsetY = -(double) ((Vector2) velocity4).Y;
        localMatrix2.Translate((float) offsetX, (float) offsetY);
      }
            // ISSUE: explicit constructor call
            velocity1 = new Vector2(0.0f, 150f);
    ...
    private void keyDownPressed(double elapsed)
    {
      ...
      double offsetX = (double) ((Vector2) velocity1).X * elapsed;
      Vector2 velocity2 = ((Sprite) this).Velocity;
      double offsetY = (double) ((Vector2) velocity2).Y * elapsed;
    ...
    private void ActivateArrow()
    {
      ...
      Vector2 vector2_1;
            // ISSUE: explicit constructor call
            vector2_1 = new Vector2(0.0f, 150f);
